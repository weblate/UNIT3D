 ...
 */
    ...
    'fail-login-line2' => 'Cette demande provient de :ip (:host) à :time',
    ...
    'register-code' => 'Pour finaliser l\'activation de votre compte, cliquez sur le bouton ci-dessous',
    ...
    'register-header' => 'Salut ! Merci de vous être inscrit·e sur',
    ...
    'unban-footer' => 'Nous saluons votre retour !',
    'unban-header' => 'Vous avez été débanni·e',
    'unban-reason' => 'Raison',
    'username-reminder' => 'Vous nous avez récemment envoyé une demande pour votre nom d\'utilisateur·ice sur notre application. Votre nom d\'utilisateur·ice est',
    'username-sent' => 'Votre nom d\'utilisateur·ice a été envoyé à votre adresse mail !',
    'disabled-header' => 'Votre compte a été désactivé',
    'pruned-header' => 'Votre compte a été nettoyé',
];
