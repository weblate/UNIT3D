 ...
 */
    ...
    'invites-rules' => [
        ...
        'responsibile' => 'Ви особисто відповідаєте за тих, кого запрошуєте.',
    ],
    ...
    'client-connectable-state' => '{0}Ні|{1}Так|{1}Так',
    'profile-is-private' => 'Ваш профіль налаштовано як приватний',
    'show-adult-content' => 'Показати вміст для дорослих серед торрентів та на домашній сторінці',
];
