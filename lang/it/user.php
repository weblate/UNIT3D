 ...
 */
    ...
    'account-notification-help' => 'Controlla quali notifiche vengono inviate riguardanti il tuo account.
    Queste impostazioni sono sovrascritte se non si consente ai gruppi di inviare notifiche relative al proprio account o se si <strong>disabilitano le notifiche</strong>',
    ...
    'achievement-help' => 'Controlla la condivisione di specifiche informazioni relative ai risultati con gruppi ai quali è consentito accedere al tuo profilo.
 Queste impostazioni sono sovrascritte se non permetti a nessun gruppo di accedere ai tuoi risultati o se <strong>vai privato</strong>',
    ...
    'bon-notification-help' => 'Controlla quali notifiche vengono inviate riguardo alle transazioni BON.
    Queste impostazioni sono sovrascritte se non si consente a nessun gruppo di inviare notifiche relative a BON o se si <strong>disabilitano le notifiche</strong>',
    ...
    'follower-help' => 'Controlla la condivisione di specifiche informazioni relative ai follower con gruppi a cui è consentito l\'accesso al tuo profilo.
    Queste impostazioni sono sovrascritte se non permetti a nessun gruppo di accedere ai tuoi follower o se <strong>vai privato</strong>',
    'followers' => 'Seguaci',
    ...
    'following-notification-help' => 'Controlla quali notifiche vengono inviate riguardo le azioni sul sito dell\'utente seguito.
    Queste impostazioni sono sovrascritte se non si consente a nessun gruppo di inviare notifiche relative agli utenti seguiti o se si <strong>disabilitano le notifiche</strong>',
    ...
    'forum-notification-help' => 'Controlla quali notifiche vengono inviate riguardo alle attività del forum.
    Queste impostazioni sono sovrascritte se non si consente a gruppi di inviare notifiche relative alle attività del forum o se si <strong>disabilitano le notifiche</strong>',
    ...
    'forum-help' => 'Controlla la condivisione di statistiche e informazioni relative ai forum specifici con gruppi ai quali è consentito accedere al tuo profilo.
    Queste impostazioni sono sovrascritte se non si consente a nessun gruppo di accedere alle statistiche e alle informazioni relative al forum o se si è <strong>privati</strong>',
    ...
    'mention-notification-help' => 'Controlla quali notifiche vengono inviate quando un utente ti menziona.
    Queste impostazioni sono sovrascritte se non si consente a nessun gruppo di inviare notifiche se un utente @ ti ricorda o se si <strong>disabilitano le notifiche</strong>',
    ...
    'notification-from-account-help' => 'Riceverai solo le notifiche dell account dal sistema, dallo staff e dai seguenti gruppi.
    Queste impostazioni sono sovrascritte se si <strong>disabilitano le notifiche</strong>',
    'notification-from-bon' => 'Ricevi notifiche BON da',
    'notification-from-bon-help' => 'Riceverai solo notifiche BON dal sistema, dallo staff e dai seguenti gruppi.
    Queste impostazioni sono sovrascritte se si <strong>disabilitano le notifiche</strong>',
    'notification-from-following' => 'Ricevi notifiche utente seguite da',
    'notification-from-following-help' => 'Riceverai solo le notifiche degli utenti seguiti dai seguenti gruppi.
    Queste impostazioni sono sovrascritte se si <strong>disabilitano le notifiche</strong>',
    'notification-from-forum' => 'Ricevi notifiche del forum da',
    'notification-from-forum-help' => 'Riceverai solo le notifiche del forum dal sistema, dallo staff e dai seguenti gruppi.
    Queste impostazioni sono sovrascritte se si <strong>disabilitano le notifiche</strong>',
    'notification-from-subscription' => 'Ricevi notifiche di iscrizione da',
    'notification-from-subscription-help' => 'Riceverai solo le notifiche del forum dal sistema, dallo staff e dai seguenti gruppi.
    Queste impostazioni sono sovrascritte se si <strong>disabilitano le notifiche</strong>',
    'notification-from-torrent' => 'Ricevi notifiche Torrent da',
    'notification-from-torrent-help' => 'Riceverai solo notifiche torrent dal sistema, dallo staff e dai seguenti gruppi.
    Queste impostazioni sono sovrascritte se si <strong>disabilitano le notifiche</strong>',
    'notification-from-mention' => 'Ricevi notifiche @Mention da',
    'notification-from-mention-help' => 'Riceverai solo notifiche di menzioni dal sistema, dallo staff e dai seguenti gruppi.
    Queste impostazioni sono sovrascritte se si <strong>disabilitano le notifiche</strong>',
    'notification-from-request' => 'Ricevi notifiche di richiesta da',
    'notification-from-request-help' => 'Riceverai solo le notifiche di richiesta dal sistema, dallo staff e dai seguenti gruppi.
    Queste impostazioni sono sovrascritte se si <strong>disabilitano le notifiche</strong>',
    'notifications' => 'Notifiche',
    'offline' => 'L utente è offline!',
    'online' => 'L utente è online!',
    'options' => 'Opzioni',
    'other-help' => 'Controlla la condivisione di altre statistiche e informazioni con gruppi a cui è consentito l\'accesso al tuo profilo.
    Queste impostazioni sono sovrascritte se non si consente a nessun gruppo di accedere alle altre statistiche e informazioni o se si è <strong>privati</strong>',
    ...
    'profile-privacy-help' => 'Controlla quali statistiche e informazioni vengono visualizzate sul tuo profilo.
    Queste impostazioni sono sovrascritte se non permetti a nessun gruppo di accedere al tuo profilo o se <strong>vai privato</strong>',
    ...
    'report' => 'Segnala',
    'request-help' => 'Controlla la condivisione di statistiche e informazioni relative a richieste specifiche con gruppi a cui è consentito l\'accesso al tuo profilo.
    Queste impostazioni sono sovrascritte se non si consente a nessun gruppo di accedere alle statistiche e alle informazioni correlate richieste o se si è <strong>privati</strong>',
    'request' => 'Richiesta',
    ...
    'request-notification-help' => 'Controlla quali notifiche vengono inviate riguardo alle attività di richiesta.
    Queste impostazioni sono sovrascritte se non si consente a gruppi di inviare notifiche relative alle attività di richiesta o se si <strong>disabilitano le notifiche</strong>',
    ...
    'subscription-notification-help' => 'Controlla quali notifiche vengono inviate in merito ai tuoi abbonamenti.
    Queste impostazioni sono sovrascritte se non si consente a nessun gruppo di inviare notifiche relative agli abbonamenti o se si <strong>disabilitano le notifiche</strong>',
    ...
    'torrent-help' => 'Controlla la condivisione di statistiche e informazioni relative ai torrent specifici con gruppi a cui è consentito l\'accesso al tuo profilo.
    Queste impostazioni sono sovrascritte se non si consente a nessun gruppo di accedere alle statistiche e alle informazioni relative al torrent o se si è <strong>privati</strong>',
    ...
    'torrent-notification-help' => 'Controlla quali notifiche vengono inviate riguardo alle attività torrent.
    Queste impostazioni sono sovrascritte se non si consente a nessun gruppo di inviare notifiche relative alle attività torrent o se si <strong>disabilitano le notifiche</strong>',
...
Queste impostazioni sono sovrascritte se <strong>vai privato</strong>',
    ...
    'visible-to-other-help' => 'Altre informazioni relative al tuo account saranno visibili solo allo staff e ai seguenti gruppi.
    Queste impostazioni sono sovrascritte se <strong>vai privato</strong> o se <strong>vai nascosto</strong>',
    'visible-to-profile' => 'Profilo visibile a',
    'visible-to-profile-help' => 'Il tuo profilo sarà visibile solo al personale e ai seguenti gruppi.
    Queste impostazioni sono sovrascritte se <strong>vai privato</strong>',
    'visible-to-request' => 'Richiedi informazioni visibili a',
    'visible-to-request-help' => 'Le informazioni sulla tua richiesta saranno visibili solo al personale e ai seguenti gruppi.
    Queste impostazioni sono sovrascritte se <strong>vai privato</strong>',
    'visible-to-torrent' => 'Informazioni sul Torrente Visibile a',
    'visible-to-torrent-help' => 'Le informazioni sul tuo torrent saranno visibili solo allo staff e ai seguenti gruppi.
    Queste impostazioni sono sovrascritte se <strong>vai privato</strong> o se <strong>vai nascosto</strong>',
    'warned-on' => 'Avvisato',
    ...
    'client-connectable-state' => 'No|Sì|Sì',
