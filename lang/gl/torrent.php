 ...
 */
    ...
    'comments-left' => 'Comentarios deixados',
    'completed-times' => 'Veces completado',
    'define-tip-amount' => 'Define a contía da propina',
    'distributor' => 'Distribuidor',
    'download-rights-active' => 'Dereitos de descarga activos',
    'end-year' => 'Fin de ano',
    'episode-number' => 'Número de episodio',
    'first-to-comment' => 'Sexa o primeiro en comentar',
    'genre-tags' => 'Etiquetas de xénero',
    'keywords' => 'Palabras clave',
    'keywords-example' => 'Exemplo: superhero, dc comics, marvel',
    'not-personal-release' => 'Non é un lanzamento persoal',
    'not-seeding' => 'Non compartindo',
    'personal-release' => 'Autorización persoal',
    'postponed' => 'Aprazado',
    'postponed-torrents' => 'Torrents aprazados',
    'publish-time' => 'Hora de publicación',
    'recent-bumped' => 'Actualizado recentemente',
    'recommendations' => 'Recomendacións',
    'refundable' => 'Reembolsable',
    'refunded' => 'Reembolsado',
    'region' => 'Rexión',
    'required-anime' => 'Necesario para o anime',
    'required-games' => 'Necesario para os xogos',
    'reseed-requests' => 'Solicitudes de resementa',
    'revokefeatured' => 'Retirar o destacado',
    'search-by-name' => 'Buscar por nome',
    'season-number' => 'Número de tempada',
    'season' => 'Tempada',
    'special-double_upload' => 'Publicación dobre especial',
    'staff-tools' => 'Ferramentas staff',
    'start-year' => 'Ano de inicio',
    'subtitle-included' => 'Este torrent xa inclúe os seguintes subtítulos integrados:',
