 ...
 */
    ...
    'account-notification-help' => 'Lege fest, welche Benachrichtigungen deinem Konto betreffend gesendet werden. 
Diese Einstellungen werden überschrieben, wenn du die Benachrichtigung aller Gruppen nicht zulässt, oder wenn du <strong>Benachrichtigungen deaktivierst</strong>',
    ...
    'achievement-help' => 'Lege das Teilen bestimmter Achievements mit Gruppen fest, welche Zugriff auf dein Profil haben. 
Diese Einstellungen werden überschrieben, wenn du die Benachrichtigung aller Gruppen nicht zulässt oder wenn du <strong>privat gehst</strong>',
    ...
    'bon-notification-help' => 'Lege fest, welche Benachrichtigungen über Bonus-Transaktionen gesendet werden. 
Diese Einstellungen werden überschrieben, wenn du die Benachrichtigung aller Gruppen nicht zulässt, oder wenn du <strong>Benachrichtigungen deaktivierst</strong>',
    ...
    'certified-seeder-desc' => 'Seede 150 oder mehr Torrents!',
    ...
    'follower-help' => 'Kontrolliere die Freigabe bestimmter Follower-bezogener Informationen mit Gruppen, die auf dein Profil zugreifen dürfen. 
Diese Einstellungen werden überschrieben, wenn du keiner Gruppe den Zugriff auf deine Follower erlaubst oder wenn du <strong>privat gehst</strong>',
    'followers' => 'Follower',
    'following-notification' => 'Einstellungen für Follower Benachrichtigungen',
    'following-notification-upload' => 'Erhalte eine Benachrichtigung, wenn ein nachfolgender Nutzer einen Torrent hochlädt',
    'following-notification-help' => 'Lege fest, welche Benachrichtigungen über Follower Aktionen gesendet werden. 
Diese Einstellungen werden überschrieben, wenn du die Benachrichtigung aller Gruppen nicht zulässt, oder wenn du <strong>Benachrichtigungen deaktivierst</strong>',
    ...
    'forum-notification-help' => 'Kontrolliere, welche Benachrichtigungen über Forumaktivitäten gesendet werden. 
Diese Einstellungen werden überschrieben, wenn du die Benachrichtigung aller Gruppen nicht zulässt, oder wenn du <strong>Benachrichtigungen deaktivierst</strong>',
    ...
    'forum-help' => 'Steuer den Austausch bestimmter forumsbezogener Statistiken und Informationen mit Gruppen, die auf dein Profil zugreifen dürfen. 
Diese Einstellungen werden überschrieben, wenn du keine Gruppe den Zugriff erlaubst oder wenn du <strong>privat gehst</strong>',
    'forum-signature' => 'Forum Signatur',
    'forums' => 'Foren',
    'general' => 'Allgemein',
    'general-settings' => 'Allgemeine Einstellungen',
    'gift-given' => 'Geschenke vergeben',
    ...
    'hit-n-runs' => 'Hit & Runs',
    'hit-n-runs-count' => 'Anzahl Hit and Runs (gesamter Zeitraum)',
    'hit-n-runs-history' => 'Hin & Run Verlauf',
    ...
    'invites' => 'Invites',
    'invites-banned' => 'Fehler: Deine Invite-Rechte wurden deaktiviert',
    'invites-banned-desc' => 'Wenn du das Gefühl hast, dass das fehlerhaft ist, wende dich bitte an das Team!',
    ...
    'invites-rules' => [
        ...
        'responsibile' => 'Du bist persönlich verantwortlich für all deine Einladungen.',
    ],
    ...
    'mention-notification' => 'Einstellungen für @-Erwähnungsbenachrichtigungen',
    ...
    'mention-notification-help' => 'Lege fest, welche Benachrichtigungen gesendet werden, wenn ein Nutzer dich benachrichtigt. 
Diese Einstellungen werden außer Kraft gesetzt, wenn du alle Gruppenbenachrichtigungen deaktiviert sind, wenn ein Nutzer dich @erwähnt oder <strong>Benachrichtigungen</strong> deaktiviert ist',
    ...
    'notification-from-account-help' => 'Du erhältst nur Kontobenachrichtigungen vom System, Team und den folgenden Gruppen. 
Diese Einstellungen werden überschrieben, wenn du <strong>Benachrichtigungen deaktivierst</strong>',
    'notification-from-bon' => 'Erhalte Bonuspunkte-Benachrichtigungen von',
    'notification-from-bon-help' => 'Du erhältst nur Bonus-Benachrichtigungen vom System, Team und den folgenden Gruppen. 
Diese Einstellungen werden überschrieben, wenn du <strong>Benachrichtigungen deaktivierst</strong>',
    'notification-from-following' => 'Erhalte Benachrichtigungen über User die dir Folgen von',
    ...
    'notification-from-forum-help' => 'Du erhältst nur Forumbenachrichtigungen vom System, Team und den folgenden Gruppen. 
Diese Einstellungen werden überschrieben, wenn du <strong>Benachrichtigungen deaktivierst</strong>',
    ...
    'notification-from-torrent-help' => 'Du erhältst nur Torrent-Benachrichtigungen vom System, Team und den folgenden Gruppen. 
Diese Einstellungen werden überschrieben, wenn du <strong>Benachrichtigungen deaktivierst</strong>',
    'notification-from-mention' => 'Erhalte @Erwähnungs-Benachrichtigungen von',
    'notification-from-mention-help' => 'Du erhältst nur @Erwähnungs-Benachrichtigungen vom System, Team und den folgenden Gruppen. 
Diese Einstellungen werden überschrieben, wenn du <strong>Benachrichtigungen deaktivierst</strong>',
    'notification-from-request' => 'Erhalte Request-Benachrichtigungen von',
    'notification-from-request-help' => 'Du erhältst nur Request-Benachrichtigungen vom System, Team und den folgenden Gruppen. 
Diese Einstellungen werden überschrieben, wenn du <strong>Benachrichtigungen deaktivierst</strong>',
    'notifications' => 'Benachrichtigungen',
    'offline' => 'Nutzer ist offline!',
    'online' => 'Nutzer ist online!',
    'options' => 'Optionen',
    'other-help' => 'Steuere die Freigabe anderer Statistiken und Informationen mit Gruppen, die auf dein Profil zugreifen dürfen. 
Diese Einstellungen werden überschrieben, wenn du keiner Gruppe den Zugriff gestattest oder wenn du <strong>privat gehst</strong>',
    ...
    'private-forum-profile' => 'Achtung: Der Verlauf der Themen und Posthistorie wurde von diesem User auf PRIVAT gesetzt!',
    ...
    'profile-privacy-help' => 'Lege fest, welche Statistiken und Informationen in deinem Profil angezeigt werden. 
Diese Einstellungen werden überschrieben, wenn keiner Gruppe den Zugriff aktiviert sind oder wenn du <strong>privat gehst</strong>',
    ...
    'request-help' => 'Steuere den Austausch bestimmter Request-bezogener Statistiken und Informationen mit Gruppen, die auf dein Profil zugreifen dürfen. 
Diese Einstellungen werden überschrieben, wenn keine der unten aufgeführten Gruppen aktiviert ist oder wenn du <strong>privat gehst</strong>',
    'request' => 'Request',
    'requested' => 'Requestes',
    'requests' => 'Requests',
    ...
    'request-notification-help' => 'Lege fest, welche Benachrichtigungen bezüglich Requests gesendet werden. 
Diese Einstellungen werden überschrieben, wenn keine der unten aufgeführten Gruppen aktiviert ist oder du <strong>Benachrichtigungen deaktivierst</strong>',
    'request-privacy' => 'Request Einstellungen',
    'request-privacy-requested' => 'Erlaube Nutzern, deine Request Liste anzuzeigen',
    'reset-passkey' => 'Passkey (PID) zurücksetzen',
    ...
    'search' => 'Schnelle Suche nach Nutzername/E-Mail',
    'security' => 'Sicherheit',
    ...
    'soft-deleted-warnings' => 'gelöschte Soft-Warnings',
    'staff-noted' => 'Notiz durchs Team',
    ...
    'subscription-notification-help' => 'Lege fest, welche Benachrichtigungen zu deinen Abonnements gesendet werden. 
Diese Einstellungen werden überschrieben, wenn keine der unten aufgeführten Gruppen aktiviert ist, oder wenn du <strong>Benachrichtigungen deaktivierst</strong>',
    'thanks-given' => 'Danke gesagt',
    ...
    'top-seeding-size' => 'Top Seedgröße (GB)',
    ...
    'torrent-comments' => 'Torrent-Kommentare geschrieben',
    'torrent-help' => 'Steuere die Freigabe bestimmter Statistiken und Informationen zum Torrent mit Gruppen, die auf dein Profil zugreifen dürfen. 
Diese Einstellungen werden überschrieben, wenn keine Gruppe Zugriff auf deine Torrent-Statistiken und -Informationen hat oder wenn du <strong>privat gehst</strong>',
    ...
    'torrent-notification-help' => 'Kontrolliere, welche Benachrichtigungen du über Torrent-Aktivitäten bekommst. 
Diese Einstellungen werden überschrieben, wenn der Zugriff aller Gruppen deaktiviert ist, oder wenn du <strong>Benachrichtigungen deaktivierst</strong>',
    ...
    'total-leeching' => 'Leechend (Gesamtanzahl)',
    'total-seeding' => 'Seedend (Gesamtanzahl)',
    'total-seedtime' => 'Gesamte Seedzeit',
    ...
    'upload-bon' => 'Upload hinzugefügt vom Bonus Shop',
    ...
    'visible-to-achievement-help' => 'Deine Leistungen sind nur für Teammitglieder und die folgenden Gruppen sichtbar. 
Diese Einstellungen werden überschrieben, wenn du <strong>privat gehst</strong>',
    'visible-to-follower' => 'Followers sichtbar für',
    'visible-to-follower-help' => 'Deine Follower sind nur für Teammitglieder und die folgenden Gruppen sichtbar. 
Diese Einstellungen werden überschrieben, wenn du <strong>privat gehst</strong>',
    'visible-to-forum' => 'Forum-Informationen sichtbar für',
    'visible-to-forum-help' => 'Deine Foruminformationen sind nur für Teammitglieder und die folgenden Gruppen sichtbar. 
Diese Einstellungen werden überschrieben, wenn du <strong>privat gehst</strong>',
    'visible-to-other' => 'sichtbar für Andere',
    'visible-to-other-help' => 'Andere Informationen zu deinem Konto sind nur für Teammitglieder und die folgenden Gruppen sichtbar. 
Diese Einstellungen werden überschrieben, wenn du <strong>privat gehst</strong> oder <strong>verborgen</strong> bist',
    'visible-to-profile' => 'Profil sichtbar für',
    'visible-to-profile-help' => 'Dein Profil ist nur für Mitarbeiter und die folgenden Gruppen sichtbar. 
Diese Einstellungen werden überschrieben, wenn du <strong>privat gehst</strong>',
    'visible-to-request' => 'Informationen anfordern, die sichtbar sind für',
    'visible-to-request-help' => 'Deine Anforderungsinformationen sind nur für Teammitglieder und die folgenden Gruppen sichtbar. 
Diese Einstellungen werden überschrieben, wenn du <strong>privat gehst</strong>',
    'visible-to-torrent' => 'Torrent-Informationen sichtbar für',
    'visible-to-torrent-help' => 'Deine Torrent-Informationen sind nur für Teammitglieder und die folgenden Gruppen sichtbar.
Diese Einstellungen werden überschrieben, wenn du <strong>privat gehst</strong> oder <strong>verborgen</strong> bist.',
    ...
    'reason-ban' => 'Banngrund',
    'reason-unban' => 'Grund der Entsperrung',
    'removed' => 'Entfernt',
    'reset-api-token' => 'API Token zurücksetzen',
    'personal-releases' => 'persönliches Releases',
    'warnings' => 'Verwarnungen',
    'not-satisfied-not-immune' => 'Nicht befriedigt / Nicht immun',
    'profile-is-private' => 'Dein Profil ist auf privat gestellt',
    'reset-api-help' => 'Du musst nach dem Zurücksetzen alle benutzten Skripte und Programme mit dem neuen API-Key ausstatten.',
    'restore' => 'Widerherstellen',
    'rsskey' => 'RSS Schlüssel',
    'rsskeys' => 'RSS-Schlüssel',
    'satisfied-immune' => 'Befriedigt / Immun',
    'top-bountied' => 'Meiste Bonuspunkte',
    'top-completed' => 'Meiste fertiggestellte',
    'top-dead' => 'Beliebteste tote',
    'top-dying' => 'Beliebteste sterbende',
    'top-leeched' => 'Meistgeleechte',
    'top-seeded' => 'Meistgeseedete',
    'show-adult-content' => 'Zeige erwachsenen Inhalte in der Torrentsuche und Webseitenblöcken',
    'total-internal-releases' => 'Gesamte interne Veröffentlichungen',
    'total-personal-releases' => 'Gesamte persönliche Veröffentlichungen',
    'two-step-auth' => [
        'title' => 'Zwei-Faktor Authentifizierung',
        'totp' => 'Zeitbasierte Einmalpasswort (TOTP) Authetifizierung',
        'email' => 'E-Mail Authentifizierung',
        'totp-is-enabled' => 'TOTP Authentifizierung ist derzeit aktiviert. Um sie zu deaktivieren, klicke den \'Deaktivieren\'-Button weiter unten.',
        'totp-is-disabled' => 'TOTP Authetifizierung ist derzeit deaktiviert. Um sie zu aktivieren, klicke auf den \'Aktivieren\'-Button weiter unten.',
        'password-confirm' => 'Erfordert Passwortauthetifizierung',
        'upon-enabling' => 'Sobald aktiviert, musst du einen gültigen 2-Faktor-Authetifizierungscode eingeben.',
        'complete-setup' => 'Um die TOTP Authetifizierung abzuschließen, scanne den Code weiter unten mit deiner Authentifikator-App (Google Authenticator, Authy, BitWarden, etc.) und trage den TOTP Code in das Feld weiter unten ein.',
        'confirm-code' => 'Bestätige den TOTP Code',
        'recovery-code' => 'Zeitbasierte Einmalpasswort (TOTP) Widerherstellungscodes',
        'recovery-code-description' => 'Klicke den \'Zeige\' Button um deine Widerherstellungscodes für deinen Account anzuzeigen. Speichere diese Codes sicher, z.B. offline, falls du den Zugriff auf dein TOTP Gerät verlierst. Wenn du denkst, diese Codes wurden kompromittiert, klicke bitte auf den \'Reset\'-Button um neue Codes zu erzeugen.',
        'recovery-code-reveal' => 'Anzeigen',
        'recovery-code-reset' => 'Zurücksetzen',
    ],
    'upload-snatches' => 'Geschnappte Uploads',
    'unregistered-info-hashes' => 'Nicht registrierte Info Hashes',
];
